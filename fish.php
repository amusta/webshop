...
<section class="breadcrumb-section set-bg" data-setbg="img/fish.png">
    <div class="container">
        <div class="row">
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="checkout__order__toys">
                            <div class="checkout__order__toys__h4"><a href="toys.php">Tanks</a></div>
                            <ul>
                                <li>Aquarium</li>
                                <li>Round</li>
                                <li>Cabinet</li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="checkout__order__treats">
                            <div class="checkout__order__treats__h4"><a href="treats.php">Lighting</a></div>
                            <ul>
                                <li>LED</li>
                                <li>Bulbs</li>
                                <li>Lamps</li>
                ...
                <div class="row top-buffer">
                    <div class="col-lg-4 col-md-6 col-sm-6 ">
                        <div class="checkout__order__leads">
                            <div class="checkout__order__leads__h4"><a href="litter.php">Filters</a></div>
                            <ul>
                                <li>Goldfish</li>
                                <li>Temperate</li>
                                <li>Tropical</li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="checkout__order__groom">
                            <div class="checkout__order__groom__h4"><a href="trees.php">Gravel & sand</a></div>
                            <ul>
                                <li>Sand</li>
                                <li>Glavel</li>
                                <li>Natural</li>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="checkout__order__bed">
                            <div class="checkout__order__bed__h4"><a href="bed.php">Plants & aquascaping</a></div>
                            <ul>
                                <li>Natular</li>
                                <li>Metal</li>
