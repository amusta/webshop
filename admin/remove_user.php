...
if(!empty($_REQUEST['term'])) {
    ...
    $sql = "SELECT * FROM users WHERE User_name LIKE '%" . $term . "%' ";
    $result = $conn->query($sql);
}
?>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-4 ">
                <h5><?php echo $row['User_name'];  ?></a></h5>
            ...
            <h6><?php echo $row['Email'];  ?></h6>
                    ...
                    <?php if(isAdmin()) echo "<a href='remove_user.php?ID=". $row["ID_users"] ."' ><button type=\"button\" class=\"btn btn-danger btn-sm\">Delete</button></a> "; ?>
