...
<section class="breadcrumb-section set-bg" data-setbg="img/small_pet.png">
    <div class="container">
        <div class="row">
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="checkout__order__treats">
                            <div class="checkout__order__treats__h4"><a href="treats.php">Straw & bedding</a></div>
                            <ul>
                                <li>Straw</li>
                                <li>Litter</li>
                                <li>Hemp & corn bedding</li>
                            </ul>
                        </div>
                ...
                <div class="row top-buffer">
                    <div class="col-lg-4 col-md-6 col-sm-6 ">
                        <div class="checkout__order__leads">
                            ...
                            <ul>
                                <li>Nibble wood</li>
                                <li>Natural snacks</li>
                                <li>Herbs, blossoms & grass</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="checkout__order__groom">
                            ...
                            <ul>
                                <li>Tunnels & dens</li>
                                <li>Exercise wheels</li>
                                <li>Bridges & stairs</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="checkout__order__bed">
                            <div class="checkout__order__bed__h4"><a href="bed.php">Care & grooming</a></div>
                            <ul>
                                <li>Eye & ear care</li>
                                <li>Fur & coat care</li>
                                <li>Nail & claw </li>
